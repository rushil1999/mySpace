...
const BoxContainer = () => {
	...
	useEffect(() => {
		...
		// 		console.log(`${snapshot.val()[property].description}`);
		// 		console.log(`${snapshot.val()[property].name}`);
		// 		// console.log(`${snapshot.val()[property]}`);
		// 		var inp = { name: snapshot.val()[property].name, description: snapshot.val()[property].description };
		// 		tempBox.push(inp);
		// 	}
		// 	setBox(tempBox);
		// });
